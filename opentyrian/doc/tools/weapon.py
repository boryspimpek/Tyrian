...
def printHelp():
	print(r"Usage: weapon.py toxml C:\Users\borys\projekty\Galaxid\tyrian21\tyrian.hdt output.xml")
	print(r"       weapon.py tohdt input.xml C:\Users\borys\projekty\Galaxid\tyrian21\tyrian.hdt")
	sys.exit(1)
